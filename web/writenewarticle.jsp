...
<div id="main">
    ...
    <h2>Title: </h2><input type="search" id="newarticile_title" placeholder="Title" />
    <br>

    <br>
        <h2>Body part</h2>
        <textarea id="bodypart" placeholder="Body part"></textarea>
        <br>
        <button type="button" id="btn_newarticle" value="submit" >Sumbit</button>
