...
INSERT INTO project_article (article_title, article_content, author_id, article_visibility, article_date)
VALUES ('heading 2', 'content article 2', 1, TRUE, DATE '2018-03-17');
...
INSERT INTO project_user (user_firstname, user_lastname, user_gender,user_country, user_dob,
  ...
  ('b2', 'b2', 'male','NZ', DATE '2015-12-17', 'b@com','b', 'b', 'b');

INSERT INTO project_article_comment (user_id, article_id, article_comment, comment_visibility, on_article, is_parent)
VALUES (1, 1, 'user 1, article 1', TRUE, TRUE, TRUE);
INSERT INTO project_article_comment (user_id, article_id, article_comment, comment_visibility, on_article, is_parent)
VALUES (1, 1, 'user 1, article 2', TRUE, TRUE, FALSE);
INSERT INTO project_article_comment (user_id, article_id, article_comment, comment_visibility, on_article, is_parent)
VALUES (1, 1, 'user 1, article 2a', TRUE, FALSE, FALSE);

INSERT INTO project_comment_relationship (parent_id, child_id) VALUES (1, 3);

INSERT  INTO project_admin (admin_name, admin_username, admin_password, admin_created_date, admin_authority) VALUES
  ('aaa','a','a',DATE '2017-12-01',0);
...
FROM project_article
  JOIN project_article_comment ON project_article.article_id = project_article_comment.article_id
WHERE user_id = 1;
...
UPDATE project_article
SET article_visibility = FALSE
WHERE article_id = 8;

SELECT article_visibility
FROM project_article
WHERE article_id = 8;

SELECT *
FROM project_article
WHERE article_visibility = TRUE AND article_date <= CURDATE();
...
FROM project_user_article
WHERE article_id = 1;
UPDATE project_article_comment
SET is_parent = TRUE
WHERE comment_id = 2;
...
WHERE user_id = 1;
DELETE * FROM project_comment_relationship
WHERE parent_id =1;

SELECT comment_id
FROM project_article_comment
WHERE is_parent = TRUE AND article_id = 1;

INSERT INTO project_article_images (article_id, image_source) VALUES (?, ?);

DELETE FROM project_article_images WHERE article_id = 1;