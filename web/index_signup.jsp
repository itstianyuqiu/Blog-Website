...
<form action="/UserNewAccountServlet" method="get">
    <div id="signup_frame_signup">
        ...
        <br>
        <br>
        <input placeholder="  Username " type="text" name="username" id="signup_username" class="signup_text_field_usernameemailpassword"/>
        <br>
        <br>
        ...
        <div id="signup_control">
            ...
            <button type="submit" id="btn_signup" value="Sign up" >Sign up</button>
        </div>
    </div>
</form>
</body>
